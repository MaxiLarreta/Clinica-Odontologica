...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        userRepository.save(new AppUser("Maxi", "maxi", "maxi@larreta.com", hashedPassword, AppUserRole.ADMIN));
        userRepository.save(new AppUser("Agustina", "agus", "agus@gmail.com", hashedPassword2, AppUserRole.USER));
    }
}
